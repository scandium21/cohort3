...
const testArrLoopFunc = (testMessage, testFunc) => {
  ...
  test(testMessage, () => {
    ...
    for (let i in staffEmailList) {
      expect(staffEmailListGen[i]).toEqual(staffEmailList[i]);
    }
  });
};
...
testArrLoopFunc('testing loopStaffIn()', functions.loopStaffForEach);
// Write your tests here
testArrLoopFunc('testing loopStaffOf()', functions.loopStaffMap);
