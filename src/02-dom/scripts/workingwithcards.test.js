...
test("testing addCardT (add card to top)", () => {
  wc.addCardT(div, divr, "4");
  expect(div.childElementCount).toEqual(3);
  wc.addCardT(div, divr, "5");
  expect(div.childElementCount).toEqual(4);
  expect(div.children[0].textContent).toMatch("Card 5");
...
test("testing deleteCurrCard()", () => {
  ...
  expect(div.childElementCount).toEqual(3);
  expect(divr.childElementCount).toEqual(3);
  expect(div.children[0].textContent).toMatch("Card 4");
